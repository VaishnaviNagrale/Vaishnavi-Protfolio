...
function Footer() {
  return (
    <div>
        <footer className="footer items-center p-4 text-neutral-content bg-base-200">
  <aside className="items-center grid-flow-col">
    ...
    <p>Copyright © 2024 - Made with ❤️ By Vaishnavi Nagrale</p>
  </aside> 
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <a href="https://www.linkedin.com/in/vaishnavi-nagrale/" target="_blank"><img src={linkedin} alt="LinkedIn" className="w-8 h-8" /></a>
    <a href="https://github.com/VaishnaviNagrale" target="_blank"><img src={github} alt="Github" className="w-8 h-8" /></a>
  </nav>
</footer>
    </div>
  )
